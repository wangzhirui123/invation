...
class ZhejiangzhaobiaoSpider(scrapy.Spider):
    ...
    start_urls = ['http://manager.zjzfcg.gov.cn/cms/api/cors/getRemoteResults?pageSize=15&pageNo=1&noticeType=20&url=http%3A%2F%2Fnotice.zcy.gov.cn%2Fnew%2FnoticeSearch']
