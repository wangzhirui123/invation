...
class HebeizhengfucaigouSpider(scrapy.Spider):
    ...
    class_type ="1"
    # allowed_domains = ['http://www.ccgp-hebei.gov.cn/province/cggg/zbgg/index_746.html']
    # start_urls = ['http://www.ccgp-hebei.gov.cn/province/cggg/zbgg/index_746.html/']

    def start_requests(self):

        yield scrapy.Request('http://search.hebcz.gov.cn:8080/was5/web/search?channelid=228483&province=130000000&city=&select=&searchword=&searchword1=',meta={"city":"省本级"})
